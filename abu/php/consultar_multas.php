...
// O arquivo verificar_sessao.php já tem o caminho correto para a conexão.
require_once 'verificar_sessao.php';

// --- BUSCA DADOS DO USUÁRIO LOGADO PARA O CABEÇALHO ---
$user_id = $_SESSION['user_id'];
$user_name = 'Usuário';
// CAMINHO CORRIGIDO: Apontando para a localização correta do avatar padrão (subindo 2 níveis).
...
try {
    ...
    if ($user) {
        ...
        if (!empty($user['profile_photo'])) {
            // CAMINHO CORRIGIDO: Monta o caminho relativo correto para a foto do usuário.
...
<head>
    ...
    <title>Consultar Multas - Painel</title>
    ...
    <div class="main-content">
        <header class="main-header">
            <div class="header-left">
                ...
                <h2 class="header-title">Consultar Multas</h2>
            </div>
            ...
            <div class="card">
                <div class="form-section">
                    ...
                    <div class="form-group">
                        <label for="busca-multa">Buscar por Placa, Condutor ou Código da Infração</label>
                        <input type="text" id="busca-multa" class="form-input" placeholder="Digite para buscar..." autocomplete="off">
                    </div>
                </div>
                ...
                <div class="table-container">
                    <table class="data-table">
                        ...
                        <tbody id="tabela-multas-body"></tbody>
                    </table>
                </div>
            </div>
        </main>
